...
public class BaseClass 
{
	...
	public BaseClass()
	{
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream("F:\\workspace\\FreeCRMTest\\src\\main\\java\\com\\crm\\qa\\config\\configuration.properties");
			prop.load(ip);
	...
	public static void initiliazation ()
	{
		...
		{
			System.setProperty("webdriver.gecko.driver", "F:\\New folder\\chromedriver_win32\\geckodriver.exe");
